...
candidate. Separate unit coverage verifies that the consumer remains fail-closed
for genuinely unqualified TOOL endpoints. No Tracegraph schema or pattern version
